...
import 'package:food/state/food_event.dart';
import 'package:food/state/food_state.dart';
import 'package:food/widget/filter_bottom_sheet.dart';
import 'package:food/widget/food_item.dart';
                      ...
                      return FoodItem(
                        ...
                        onFavorite: () {
                          if (state.favoriteFoodList.contains(foodItem)) {
                            foodBloc.add(FavoriteFoodRemove(foodItem.recipeId));
                          } else {
